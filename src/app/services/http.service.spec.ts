...
describe('HttpService', () => {
  ...
  it('should call the getStarWarsCharacters() method, and return values', (done: DoneFn) => {
    spyOn(service, 'getStarWarsCharacters').and.returnValue(
      of(RESPONSE_SAMPLE)
    );
    service.getStarWarsCharacters().subscribe((response) => {
      expect(response).toEqual(RESPONSE_SAMPLE);
      done();
    });
